    ...
    function readURL(input) {
        if (input.files && input.files[0]) {
            ...
            reader.onload = function(e) {
                $('#shop_category_name').attr('src', e.target.result);
            }
            reader.readAsDataURL(input.files[0]);
        }else{
            $('#shop_category_name').attr('src', '../img_upload/shop_category/default.png');
        }
    }
    ...
    <div class="col-lg-12">
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <form role="form" method="post" onsubmit="return check();" action="index.php?content=shop_category&action=edit&id=<?PHP echo $shop_category_id;?>" enctype="multipart/form-data">
                    <div class="row">
                        <div class="col-lg-9">
                            <div class="row">
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        ...
                                        <input id="shop_category_name" name="shop_category_name" class="form-control" value="<?php echo $shop_category['shop_category_name']; ?>">
                                    </div>
                                </div>
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        <label>ชื่อประเภทร้านค้า (แสดงหน้าแรก) <font color="#F00"><b>*</b></font></label>
                                        <input id="shop_category_title" name="shop_category_title" class="form-control" value="<?php echo $shop_category['shop_category_title']; ?>">
                                    </div>
                                </div>
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        <img id="shop_category_name" src="../img_upload/shop_category/<?php if($shop_category['shop_category_image'] != ""){ echo $shop_category['shop_category_image'];} else { echo "default.png";}  ?>" class="img-responsive img-size"> 
                        ...
                        <input type="hidden" id="shop_category_id" name="shop_category_id" class="form-control" value="<?=$_GET['id']?>">
                    </div>
                    <!-- /.row (nested) --> 
                </form>
            </div>
