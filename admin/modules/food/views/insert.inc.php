...
<div class="row">
	<div class="col-lg-12">
		<form role="form" method="post" onsubmit="return check();" action="index.php?content=food&action=add" enctype="multipart/form-data">
			<div class="row">
				<div class="col-lg-9">
					<div class="row">
						<div class="col-lg-7">
							<div class="form-group">
								...
								<input id="food_name" name="food_name" class="form-control" maxlength="150">
							</div>
						</div>
						<div class="col-lg-5">
							<div class="form-group">
								...
								<select id="food_type_id" name="food_type_id" class="form-control">
									...
									<option value="<?php echo $food_type[$i]['food_type_id'] ?>"><?php echo $food_type[$i]['food_type_name'] ?></option>
									<? } ?>
								</select>
							</div>
						</div>
					...
					<div class="row">
						<div class="col-lg-4">
							<div class="form-group">
								<label>ราคา </label>
								<input id="food_price" name="food_price" class="form-control" >
							</div>
						</div>
					</div>
					<div class="row">
						<div class="col-lg-12">
							<div class="form-group">
								...
								<textarea id="food_detail" name="food_detail" class="form-control" style="min-height: 120px;"></textarea>
							</div>
						</div>
					</div>
				</div>
				<div class="col-lg-3">
					...
					<label>รูปภาพ <font color="#F00"><b>600 x 315</b></font></label>
						<div>
						<img id="image_food" src="../img_upload/food/default.png" class="img-responsive img-size"> 
