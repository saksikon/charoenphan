...
<div class="row">
	<div class="col-lg-12">
		<form role="form" method="post" onsubmit="return check();" action="index.php?content=bakery&action=add" enctype="multipart/form-data">
			<div class="row">
				<div class="col-lg-9">
					<div class="row">
						<div class="col-lg-7">
							<div class="form-group">
								...
								<input id="bakery_name" name="bakery_name" class="form-control" maxlength="150">
							</div>
						</div>
						<div class="col-lg-5">
							<div class="form-group">
								...
								<select id="bakery_type_id" name="bakery_type_id" class="form-control">
									...
									<option value="<?php echo $bakery_type[$i]['bakery_type_id'] ?>"><?php echo $bakery_type[$i]['bakery_type_name'] ?></option>
									<? } ?>
								</select>
							</div>
						</div>
					...
					<div class="row">
						<div class="col-lg-4">
							<div class="form-group">
								<label>ราคา </label>
								<input id="bakery_price" name="bakery_price" class="form-control" >
							</div>
						</div>
					</div>
					<div class="row">
						<div class="col-lg-12">
							<div class="form-group">
								...
								<textarea id="bakery_detail" name="bakery_detail" class="form-control" style="min-height: 120px;"></textarea>
							</div>
						</div>
					</div>
				</div>
				<div class="col-lg-3">
					...
					<label>รูปภาพ <font color="#F00"><b>600 x 315</b></font></label>
						<div>
						<img id="image_bakery" src="../img_upload/bakery/default.png" class="img-responsive img-size"> 
