<script>
    function check(){
        ...
        if(user_username.length == 0){
            ...
            return false;
        }else if(user_type_id.length == 0){
            alert("กรุณาเลือกประเภทผู้ดูแล");
            document.getElementById("user_type_id").focus();
            return false;
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-3">
                            <div class="form-group" align="center">
                                <img id="img_user" src="../template/images/user/default.png" class="example-avater"> 
