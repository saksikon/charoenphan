...
<div class="row">
	<div class="col-lg-12">
		<form role="form" method="post" onsubmit="return check();" action="index.php?content=branch&action=add" enctype="multipart/form-data">
			<div class="row">
				<div class="col-lg-9">
					<div class="row">
						<div class="col-lg-7">
							<div class="form-group">
								<label>ชื่อสาขา <font color="#F00"><b>*</b></font></label>
								<input id="branch_name" name="branch_name" class="form-control" maxlength="150">
							</div>
						</div>
						<div class="col-lg-5">
							<div class="form-group">
								<label>เบอร์โทรศัพท์ </label>
								<input id="branch_phone" name="branch_phone" class="form-control" maxlength="20">
							</div>
						</div>
					</div>
					<div class="row">
						<div class="col-lg-12">
							<div class="form-group">
								...
								<input id="branch_email" name="branch_email" class="form-control" maxlength="100">
							</div>
						</div>
					</div>
					<div class="row">
						<div class="col-lg-6">
							<div class="form-group">
								...
								<input id="branch_facebook" name="branch_facebook" class="form-control" maxlength="100">
							</div>
						</div>
						<div class="col-lg-6">
							<div class="form-group">
								<label>LINE ID </label>
								<input id="branch_line" name="branch_line" class="form-control" maxlength="100">
							</div>
						</div>
					</div>
					<div class="row">
						<div class="col-lg-12">
							<div class="form-group">
								...
								<input id="branch_detail" name="branch_detail" class="form-control">
							</div>
						</div>
					</div>
				</div>
				<div class="col-lg-3">
					...
					<label>รูปภาพ <font color="#F00"><b>600 x 315</b></font></label>
						<div>
						<img id="branch_image" src="../img_upload/branch/default.png" class="img-responsive img-size"> 
			...
			<div class="row">
				<div class="col-lg-12">
					<div class="form-group">
						...
						<input type="text" id="branch_address" name="branch_address" class="form-control" maxlength="200">
			...
			<div class="row">
				<div class="col-lg-3">
					<div class="form-group">
						...
						<input id="branch_district" name="branch_district" data-live-search="true" type="text" class="form-control">
					</div>
				</div>
				<div class="col-lg-3">
					<div class="form-group">
						<label>อำเภอ/เขต <font color="#F00"><b>*</b></font> </label>
						<input id="branch_amphur" name="branch_amphur" data-live-search="true" type="text" class="form-control">
					</div>
				</div>
				<div class="col-lg-3">
					<div class="form-group">
						<label>จังหวัด <font color="#F00"><b>*</b></font> </label>
						<input id="branch_province" name="branch_province" data-live-search="true" type="text" class="form-control" >
					</div>
				</div>
				<div class="col-lg-3">
					<div class="form-group">
						<label>หมายเลขไปรษณีย์ <font color="#F00"><b>*</b></font> </label>
						<input id="branch_zipcode" name="branch_zipcode" type="text" class="form-control">
					</div>
				</div>
			</div>
				...
				<div class="col-lg-12">
					<div class="form-group">
						...
						<fieldset class="gllpLatlonPicker">
							...
							<div class="row" style="padding:16px 0px;">	
								<div class="col-lg-6">
									<input type="text" class="gllpLongitude form-control" name="branch_location_long" value="102.1026744215153"/>
								</div>
								<div class="col-lg-6">
									<input type="text" class="gllpLatitude form-control" name="branch_location_lat" value="14.973483769647292"/>
								</div>
							</div>
...
<!-- <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyBPYt_mZGd-2iotzhpiZKw1_GpZ6H9w3vs&callback=initMap"></script> -->
