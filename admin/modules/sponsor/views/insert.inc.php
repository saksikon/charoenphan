    ...
    function readURL(input) {
        if (input.files && input.files[0]) {
            ...
            reader.onload = function(e) {
                $('#sponsor_image').attr('src', e.target.result);
            }
            reader.readAsDataURL(input.files[0]);
        }else{
            $('#sponsor_image').attr('src', '../img_upload/sponsor/default.png');
        }
    }
    ...
    <div class="col-lg-12">
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <form role="form" method="post" onsubmit="return check();" action="index.php?content=sponsor&action=add" enctype="multipart/form-data">
                    <div class="row">
                        <div class="col-lg-9">
                            <div class="row">
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        ...
                                        <input id="sponsor_name" name="sponsor_name" class="form-control">
                                    </div>
                                </div>
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        <label>URL ผู้สนับสนุน <font color="#F00"><b>*</b></font></label>
                                        <input id="sponsor_url" name="sponsor_url" class="form-control" value="">
                                    </div>
                                </div>
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        <img id="sponsor_image" src="../img_upload/sponsor/default.png" class="img-responsive img-size"> 
