    ...
    <div class="col-lg-12">
        <div class="panel panel-default">
            <div class="panel-body">
                <form role="form" method="post" onsubmit="return check();" action="index.php?content=about_slide&action=edit" enctype="multipart/form-data">
                    <div class="row">
                        <div class="col-lg-9">
                            <div class="row">
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        ...
                                        <input id="about_slide_header" name="about_slide_header" class="form-control"  value="<?php echo $about_slide['about_slide_header']?>">
                                    </div>
                                </div>
                                <div class="col-lg-8">
                                    <div class="form-group">
                                        <label>รายละเอียดใต้หัวข้อ </label>
                                        <input id="about_slide_header_detail" name="about_slide_header_detail" class="form-control" value="<?php echo $about_slide['about_slide_header_detail']?>">
                                    </div>
                                </div>
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        <label>รายละเอียด </label>
                                        <textarea id="about_slide_description" name="about_slide_description" class="form-control" style="min-height: 200px;"/><?php echo $about_slide['about_slide_description']?></textarea>
                                    </div>
                                </div> 
                            </div>
                        </div>
                        <div class="col-lg-3">
                            <div class="form-group">
                                ...
                                <div>
                                    <img id="img_about_slide" src="../img_upload/about_slide/<?php if($about_slide['about_slide_image'] != "") echo $about_slide['about_slide_image']; else echo "default.png"; ?>" class="img-responsive img-size"> 
                    ...
                    <div align="right">
                        <input type="hidden" id="about_slide_image_o" name="about_slide_image_o" class="form-control" value="<?php echo $about_slide['about_slide_image']?>">
                        <input type="hidden" id="about_slide_id" name="about_slide_id" value="<?php echo $about_slide['about_slide_id'] ?>" />
