...
<div class="row">
	<div class="col-lg-12">
		<form role="form" method="post" onsubmit="return check();" action="index.php?content=event&action=add" enctype="multipart/form-data">
			<div class="row">
				<div class="col-lg-6">
					<div class="form-group">
						<label>รูปภาพ <font color="#F00"><b>200 x 340</b></font></label>
						<div>
							<img id="img_event_1" src="../img_upload/event/default.png" style="height: 200px;width: 340px;" class="img-responsive"> 
				...
				<div class="col-lg-6">
					<div class="form-group" style="position: absolute;bottom: 0; width: 90%;">
						...
						<div>
							<img id="img_event_2" src="../img_upload/event/default.png" style="height: 150px;width: 200px;" class="img-responsive"> 
			...
			<div class="row">
					...
					<div class="row">
						<div class="col-lg-6">
							<div class="form-group">
								...
								<input id="event_title" name="event_title" class="form-control">
							</div>
						</div>
						<div class="col-lg-6">
							<div class="form-group">
								<label>ป้ายกำกับ <font color="#F00"><b>*</b></font></label>
								<input id="event_tag" name="event_tag" class="form-control">
							</div>
						</div>
					</div>
					<div class="row">
						<div class="col-lg-4">
							<div class="form-group">
								...
								<input type="text" name="event_date_begin" id="event_date_begin" class="form-control"/>
							</div>
						</div>
						<div class="col-lg-4">
							<div class="form-group">
								<label>วันที่สิ้นสุด <font color="#F00"><b>*</b></font></label>
								<input type="text" name="event_date_end" id="event_date_end" class="form-control"/>
							</div>
						</div>
					</div>
					...
					<div class="row">
						<div class="col-lg-12">
							<div class="form-group">
								...
								<textarea id="event_description" name="event_description" class="form-control" style="min-height: 240px;"></textarea>
							</div>
						</div>
					</div>
					<div class="row">
						<div class="col-lg-12">
							<div class="form-group">
								...
								<textarea id="event_detail" name="event_detail" class="form-control" style="min-height: 270px;"></textarea>
							</div>
						</div>
					</div>
				</div>
				...
				<div class="col-lg-3">
					<div class="form-group">
						...
						<div>
							<img id="img_event_3" src="../img_upload/event/default.png" style="height: 400px;width: 220px;" class="img-responsive"> 
					...
					<div class="form-group">
						...
						<div>
							<img id="img_event_4" src="../img_upload/event/default.png" style="height: 150px;width: 220px;" class="img-responsive"> 
