            ...
            <div class="row">
                    ...
                    <div class="row">
                        <div class="col-lg-4">
                            <div class="form-group">
                                ...
                                <input id="promotion_name" name="promotion_name" class="form-control">
                            </div>
                        </div>
                        <div class="col-lg-4">
                            <div class="form-group">
                                <label>วันที่เริ่ม <font color="#F00"><b>*</b></font></label>
                                <input type="text" name="promotion_begin" id="promotion_begin" class="form-control"/> 
                            </div>
                        </div>
                        <div class="col-lg-4">
                            <div class="form-group">
                                <label>วันที่สิ้นสุด <font color="#F00"><b>*</b></font></label>
                                <input type="text" name="promotion_end" id="promotion_end" class="form-control"/> 
                            </div>
                        </div>
                    </div>
                    <div class="row">
                ...
                <div class="col-lg-3">
                    <div class="form-group">
                        ...
                        <div>
                            <img id="img_promotion_1" src="../img_upload/promotion/default.jpg" class="img-responsive img-size"> 
            ...
            <div class="row">
                <div class="col-lg-3">
                    ...
                    <label>รูปภาพเเถบข้าง <font color="#F00"><b>600 x 315</b></font></label>
                        <div>
                            <img id="img_promotion_2" src="../img_upload/promotion/default.jpg" class="img-responsive avatar"> 
                ...
                <div class="col-lg-3">
                    ...
                    <label>รูปภาพเเถบข้าง <font color="#F00"><b>600 x 315</b></font></label>
                        <div>
                            <img id="img_promotion_3" src="../img_upload/promotion/default.jpg" class="img-responsive avatar"> 
                ...
                <div class="col-lg-3">
                    ...
                    <label>รูปภาพเเถบข้าง <font color="#F00"><b>600 x 315</b></font></label>
                        <div>
                            <img id="img_promotion_4" src="../img_upload/promotion/default.jpg" class="img-responsive avatar"> 
