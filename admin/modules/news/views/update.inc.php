...
<div class="row">
	<div class="col-lg-12">
		<form role="form" method="post" onsubmit="return check();" action="index.php?content=news&action=edit" enctype="multipart/form-data">
			<div class="row">
				<div class="col-lg-6">
					<div class="form-group">
						<label>รูปภาพข่าว <font color="#F00"><b>200 x 340</b></font></label>
						<div>
							<img id="img_news_1" src="../img_upload/news/<?php if($news['news_image_1'] != "") echo $news['news_image_1']; else echo "default.png"; ?>" style="height: 200px;width: 340px;" class="img-responsive"> 
				...
				<div class="col-lg-6">
					<div class="form-group" style="position: absolute;bottom: 0; width: 90%;">
						<label>รูปภาพข่าว <font color="#F00"><b>150 x 200</b></font></label>
						<div>
							<img id="img_news_2" src="../img_upload/news/<?php if($news['news_image_2'] != "") echo $news['news_image_2']; else echo "default.png"; ?>" style="height: 150px;width: 200px;" class="img-responsive"> 
			...
			<div class="row">
					...
					<div class="row">
						<div class="col-lg-6">
							<div class="form-group">
								...
								<input id="news_title" name="news_title" class="form-control" value="<? echo $news['news_title']; ?>">
							</div>
						</div>
						<div class="col-lg-6">
							<div class="form-group">
								<label>ป้ายกำกับ <font color="#F00"><b>*</b></font></label>
								<input id="news_tag" name="news_tag" class="form-control" value="<? echo $news['news_tag']; ?>">
							</div>
						</div>
					</div>
					<div class="row">
						<div class="col-lg-4">
							<div class="form-group">
								...
								<input type="text" name="news_date" id="news_date" class="form-control" value="<? echo $news['news_date']; ?>">
							</div>
						</div>
					</div>
					<div class="row">
						<div class="col-lg-12">
							<div class="form-group">
								...
								<textarea id="news_description" name="news_description" class="form-control" style="min-height: 240px;"><? echo $news['news_description']; ?></textarea>
							</div>
						</div>
					</div>
					<div class="row">
						<div class="col-lg-12">
							<div class="form-group">
								...
								<textarea id="news_detail" name="news_detail" class="form-control" style="min-height: 270px;"><?php echo $news['news_detail']; ?></textarea>
							</div>
						</div>
					</div>
				</div>
				...
				<div class="col-lg-3">
					<div class="form-group">
						...
						<div>
							<img id="img_news_3" src="../img_upload/news/<?php if($news['news_image_3'] != "") echo $news['news_image_3']; else echo "default.png"; ?>" style="height: 400px;width: 220px;" class="img-responsive"> 
					...
					<div class="form-group">
						...
						<div>
							<img id="img_news_4" src="../img_upload/news/<?php if($news['news_image_4'] != "") echo $news['news_image_4']; else echo "default.png"; ?>" style="height: 150px;width: 220px;" class="img-responsive"> 
			...
			<!-- /.row (nested) -->			
			<div align="right">
				<input type="hidden" id="news_id" name="news_id" class="form-control" value="<?php echo $news['news_id']; ?>">
				<input type="hidden" id="news_image_o_1" name="news_image_o_1" class="form-control" value="<?php echo $news['news_image_1']; ?>">
				<input type="hidden" id="news_image_o_2" name="news_image_o_2" class="form-control" value="<?php echo $news['news_image_2']; ?>">
				<input type="hidden" id="news_image_o_3" name="news_image_o_3" class="form-control" value="<?php echo $news['news_image_3']; ?>">
				<input type="hidden" id="news_image_o_4" name="news_image_o_4" class="form-control" value="<?php echo $news['news_image_4']; ?>">
